...
torch.save(model_deep.state_dict(), "deep_model_HighLowInputDiffTL.pth")
...
for name, (predictions, mse_loss) in results.items():
    ...
    plt.title(f'Comparison of {name}',fontsize = 14)
    plt.ylabel('Average Total Waiting Time(s)',fontsize = 14)
