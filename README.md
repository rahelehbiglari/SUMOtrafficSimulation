...
# 204 MAP Jan Gladine
Towards a digital twin of a traffic system using self-adaptive abstraction and approximation
...
```
cd existing_repo
git remote add origin https://cosysgit.uantwerpen.be/rbiglari/2023_24_map_jangladine.git
git branch -M main
...
- [ ] [Set up project integrations](https://cosysgit.uantwerpen.be/rbiglari/2023_24_map_jangladine/-/settings/integrations)
